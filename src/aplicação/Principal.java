...
//			return 1;
	...
	public static void main(String[] args) {
		...
		artistas.inserir(new Artista("Lana Del Rey", LocalDate.of(1999, 10, 10), "lanadelrey@gmail.com", estadunidense, Sexo.FEMININO, new ArrayList<TipoArtista>(Arrays.asList (new TipoArtista[]{TipoArtista.INTERPRETE, TipoArtista.COMPOSITOR}))));
		artistas.inserir(new Artista("Manoel Gomes", LocalDate.of(1979, 9, 21), "manoelgomes@gmail.com", brasileiro, Sexo.MASCULINO, new ArrayList<TipoArtista>(Arrays.asList (new TipoArtista[]{TipoArtista.INTERPRETE, TipoArtista.LETRISTA, TipoArtista.COMPOSITOR}))));
		...
		artistas.alterar(artistas.artistas.get(0), new Artista("Lana Del Rey", LocalDate.of(1999, 9, 10), "lanadelrey@gmail.com", estadunidense, Sexo.FEMININO, new ArrayList<TipoArtista>(Arrays.asList (new TipoArtista[]{TipoArtista.INTERPRETE, TipoArtista.LETRISTA}))));
